...
Darbo tema yra „virtualios garso realybės sistema“. Šiuo metu virtualio ir papildytos realybės programinė įranga yra toli pažengusi, tačiau garso generacijai taip ir toliau naudojamas stereo garsas, kuriuo nėra įmanoma tiksliai atkurti aplinkos garsų.
...
Šios plokštės mikrovaldiklis dirba 225 MHz dažniu ir pasiekia 1800 milijonų instrukcijų per sekundę spartą. Taip pat ši plokštė gali atkurti aukštos kokybės 24 bitų skaitmeminį stereo garsą, turi 512 kB \textit{Flash} bei 16 MB \textit{SDRAM} atminties. \textit{JTAG}\footnote{JTAG - Programavimo ir testavimo jungtis.} prieinamas per \textit{USB} jungtį.
...
Paveikslas \ref{fig:quaternion_2} nusako rėmo (angl. \textit{frame}) B orientaciją, jį pasukus kampu $\theta$ pagal $A_{\hat{r}}$  ašį, kai pradinė rėmo B orientacija buvo sutapusi su rėmo A orientacija.
...
Taipogi kvaternioną galima išreikšti pasukimo matricos pavidalu \ref{equ:rotation_matrix}.

Matricinė kvaterniono išraiška labai patogi norint orientaciją paversti Eulerio kampais arba atliekant tam tikras operacijas su keletu kvaternionu. Tačiau saugoti orientacijos informaciją tokiu pavidalu nėra patogu. 
Kaip matoma iš paveikslo 5.2 apskaičiuot kvaternionams reikalingi du rėmai, šiame darbe rėmu A bus laikoma žemė, o rėmas B – sistema.
Bendra filtro schema pavaizduota paveiksle 5.3. Kur (_^S)(m_t ) ̂  magnetometro duomenys, (_^S)(a_t ) ̂  – akselerometro, (_^S)(ω_t ) ̂  – giroskopo parodymai. 5.3 paveikslėlis parodo pilnąjį Madgwicko filtrą MARG sistemai. Grupė 1 skirta pašalinti magnetometro magnetinius triukšmus (angl. Magnetic distortion), Grupė 2 – skirta pasinaudojant akselerometro ir magnetometro duomenimis sumažinti giroskopo dreifą. Tokiu būdu filtras įgauna magnetometro triukšmo ir giroskopo dreifo kompensavimo savybes. Filtro rezultatas – (_E^S)q ̂_(est,t)   pilna objekto orientacija žemės atžvilgiu išreikšta kvaternionu. 
...
Matricinė kvaterniono išraiška labai patogi norint orientaciją paversti Eulerio kampais arba atliekant tam tikras operacijas su keletu kvaternionu. Tačiau saugoti orientacijos informaciją tokiu pavidalu nėra patogu dėl anksčiau minėto ašių užsiblokavimo. 
Kaip matoma iš paveikslo \ref{fig:quaternion_2} apskaičiuot kvaternionams reikalingi du rėmai, šiame darbe rėmu A bus laikoma žemė, o rėmas B – sistema.

\begin{figure}
  \centering
  \includegraphics[width=400px]{img/madgwick.png}
...
Pagrindiniai naudojami algoritmai buvo aprašyti 3 skyriuje, šiame poskyryje  yra aptarti ir paaiškinti naudojami metodai bei „Matlab“ paketo simuliacijų rezultatai.
